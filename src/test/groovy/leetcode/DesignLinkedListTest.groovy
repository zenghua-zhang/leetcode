...
class DesignLinkedListTest extends GroovyTestCase {
  DesignLinkedList.MyLinkedList _test

  void setUp() {
    super.setUp()
    def d = new DesignLinkedList();
    _test = DesignLinkedList.MyLinkedList.newInstance(d)
